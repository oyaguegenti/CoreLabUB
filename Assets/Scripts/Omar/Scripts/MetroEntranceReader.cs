...
public class MetroEntranceReader : MonoBehaviour
{
    ...
    [Header("Reader cooldown")]
    [SerializeField] private float readerCooldown = 2f;
    private bool readerLocked = false;
    ...
    private IEnumerator ReaderCooldown()
    {
        yield return new WaitForSeconds(readerCooldown);
        readerLocked = false;
    }
